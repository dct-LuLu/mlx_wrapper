...
/*   Updated: 2025/12/21 01:44:28 by jaubry--         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline int	read_key(char *line, size_t line_num, t_texture *tex, int *maxval)
{
	static const char	*keys[KEYS_NUM] = {"WIDTH", "HEIGHT", "DEPTH", "MAXVAL", "ENDHDR"};
	static const char	*scans[KEYS_NUM - 1] = {FMT_WIDTH, FMT_HEIGHT, FMT_DEPTH, FMT_MAXVAL};
	int	*const			vals[KEYS_NUM - 1] = {(int *)&tex->width, (int *)&tex->height, (int *)&tex->channels, maxval};
	size_t				i;
